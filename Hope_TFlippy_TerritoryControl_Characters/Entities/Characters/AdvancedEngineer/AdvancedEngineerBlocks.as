...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	{
	    BuildBlock b(0, "upfweaponshop", "$icon_upfweaponshop$", "UPFWeaponShop\nA workshop for UPF chicken weapons.");
...
//LOGISTICS
	...
	}
	{
		...
		AddRequirement(b.reqs, "blob", "mat_ironingot", "Iron Ingot", 80); // use autoforge sometimes!!!
	...
	{
		BuildBlock b(0, "stackseparator", "$icon_stackseparator$", "Stack Separator:\n\nUse this to separate stacks.");
		AddRequirement(b.reqs, "blob", "mat_wood", "Wood", 150);
		AddRequirement(b.reqs, "blob", "mat_stone", "Stone", 50);
		b.buildOnGround = true;
		b.size.Set(24, 16);
	...
	{
		BuildBlock b(0, "plasteelconveyor", "$plasteelconveyor$", "Conveyor Belt\nUsed to transport items.");
		AddRequirement(b.reqs, "blob", "mat_plasteel", "Plasteel", 5);
	...
	{
		BuildBlock b(0, "launchpad", "$icon_launchpad$", "Launch a real fucking space rocket in kag!");
